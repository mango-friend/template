...
const gitname = 'mango-friend' //여기에 자기 깃허브아이디를 입력하세요
const nickname = '망고프렌드' //여기에 자기 별명을 입력하세요
const myment = '달콤한 망고, 환상적인 리스트!' //여기에 상태메시지를 
const mywork = '망고챗' //여기에 자신의 대표작품을 입력하세요
const career = '2년' //여기에 자신의 경력을 입력하세요
const explanation = '갓나온 싱싱하고 달달한 망고' //여기에 자기소개를 입력하세요
const maincolor = '#FFCE00' //여기에 메인컬러를 입력하세요
const subcolor = 'FFA300' //여기에 서브컬러를 
const projectname = ['망고챗','망고캡챠']; //여기에 자기 엔트리작품 이름을 입력하세요
const projectment = ['소규모 모임부터 대규모회의까지','너 솔직히 사람 아니잖어'] //여기에 자기 엔트리작품 소개를 입력하세요
const projectid = ['5f0e886c087c9d01032a1090','5f3cc9b471ec0e021c82288f'] //여기에 자기 엔트리작품 id를 입력하세요
